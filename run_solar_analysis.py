"""
Run Solar Analysis — Orchestrator
===================================
Glue script that connects the IFC Roof Parser to the Solar Production
Engine.  Give it an IFC file and a location and it produces a full
per-segment + building-level solar yield report.
